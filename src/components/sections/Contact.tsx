...
const socialLinks = [
    ...
    {
        name: "LinkedIn",
        href: "https://linkedin.com/in/sreyansu-sekhar-mohanty",
        color: "#0077b5",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: "X",
        href: "https://x.com/SekharSreyansu",
        color: "#ffffff",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
function MagneticSocial({ social }: { social: typeof socialLinks[0] }) {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="group relative w-14 h-14 rounded-2xl bg-white/5 backdrop-blur-sm flex items-center justify-center text-text-muted transition-all duration-300 hover:text-white overflow-hidden"
...
export default function Contact() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            window.location.href = `mailto:sreyansu90@gmail.com?subject=${subject}&body=${body}`;
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-12 gap-6 md:gap-8 lg:gap-4">
                        ...
                        >
                            ...
                            <motion.a
                                href="mailto:sreyansu90@gmail.com"
                                className="group block p-8 rounded-[2rem] bg-gradient-to-br from-white/[0.07] to-white/[0.02] backdrop-blur-xl border border-white/10 hover:border-accent/30 transition-all duration-500"
                                whileHover={{ y: -4 }}
                            >
                                <div className="flex items-start justify-between mb-6">
                                    ...
                                    <svg className="w-5 h-5 text-text-muted group-hover:text-accent group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* Location Card */}
                            <motion.div
                                className="p-6 rounded-[1.5rem] bg-white/[0.03] backdrop-blur-sm border border-white/5"
                                whileHover={{ y: -2 }}
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-xs uppercase tracking-widest text-text-muted mb-0.5">Based in</p>
                                        <p className="font-medium text-text">Sambalpur, India 🇮🇳</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            {/* Social Links */}
                            <div className="pt-4">
                                <p className="text-xs uppercase tracking-widest text-text-muted mb-4">Connect with me</p>
                                <div className="flex gap-3">
                                    {socialLinks.map((social) => (
                                        <MagneticSocial key={social.name} social={social} />
                                    ))}
                                </div>
                            </div>
                        </motion.div>
